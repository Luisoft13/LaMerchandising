  ...
  <v-app class="content_app">
    <div class="content_portada">
      <div class="content_portada__title">
        <h1 class="content_portada__title_h1">Tecnología</h1>
      </div>
      <v-img
    ...
    <div class="text-center content_products_inicio">
      <v-dialog v-model="dialog" width="500">
        <template v-slot:activator="{ on, attrs }">
          <v-row>
            <v-col
              v-for="card in listProductsTecnologia"
              :key="card.code"
              :cols="card.flex"
              sm="3"
              v-bind="attrs"
...
export default {
  ...
  created() {
    this.listProductsTecnologia = listProductsTecnologia
  },
  methods: {
    showModal(card) {
